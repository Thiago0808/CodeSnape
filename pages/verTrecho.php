<div class="row">
  ...
  <div class="col-lg-12">
    ...
    <div class="col-lg-12">
        ...
        <br>
        <div class='botoes'>
          <a href='?p=deleteSnippet&id=<?=$t->id?>'><button type='button' class='btn btn-dark'>Delete</button></a>
          <a href='?p=editSnippet&id=<?=$t->id?>'><button type='button' class='btn btn-outline-dark'>Edit</button></a>
        </div>
    </div>
